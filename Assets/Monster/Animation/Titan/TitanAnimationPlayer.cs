...
public sealed class TitanAnimationPlayer : AnimationPlayerBase
{
    ...
    public string changeKey = "change";
    public string rechangeKey = "rechange";
    public string rollKey = "roll";
    ...
    void PlayNow()
    {
        ...
        if (!useDirectionOn)
        {
            stateName = SetString(motion);                 // Titan_idle / Titan_walk / Titan_run
            ApplyFlipByForwardX();
        }
        else
        {
    ...
    string ResolveMotion(MonsterStateTag tag, MonsterContext ctx)
    {
        switch (tag)
        {
            ...
            case MonsterStateTag.Change: return changeKey;
            case MonsterStateTag.ReChange: return rechangeKey;
            case MonsterStateTag.Roll: return rollKey;
